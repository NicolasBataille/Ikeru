...
| ------------------ | ------: | ------------------------------------------------ |
| `vocabulary.json`  |     688 | `vocabulary.meaning_fr`                           |
...
vocabulaire est passé de 205 à 688 mots. La **liste** vient de Tanos (CC BY),
...
`scripts/tanos/README.md`. Donc les 483 gloses anglaises ajoutées sont, comme
...
`generate_content_bundles.py`, donc insérer 483 mots les décalait tous — le
