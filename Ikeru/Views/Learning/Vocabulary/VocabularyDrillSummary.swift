...
/// End-of-session summary for vocabulary drills with accuracy stats.
struct VocabularyDrillSummary: View {
    ...
    /// the prior plant/weather emojis.
    ...
    var body: some View {
        VStack(spacing: IkeruTheme.Spacing.lg) {
            ...
            VStack(spacing: 6) {
                ...
                Text("Vocabulary drill finished")
                    .font(.ikeruCaption)
